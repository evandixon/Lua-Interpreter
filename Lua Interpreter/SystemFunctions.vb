Public Class SystemFunctions
    ...
    End Sub
    Protected Shared Function Print(Arguments As LuaObject(), ParentChunk As Chunk) As LuaObject
        Console.WriteLine(Arguments(0).ToString)
        Return LuaObject.Nil
    End Function
    Protected Shared Function Type(Arguments As LuaObject(), ParentChunk As Chunk) As LuaObject
        Return New LuaObject(Arguments(0).GetTypeName)
    End Function
    Protected Shared Function DoFile(Arguments As LuaObject(), ParentChunk As Chunk) As LuaObject
        Dim l As New LuaFile(Arguments(0).RawValue)
